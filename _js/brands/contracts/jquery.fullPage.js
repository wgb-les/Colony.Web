    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function addVerticalNavigation(){
            $body.append('<div id="' + SECTION_NAV + '"><div class="pagInner"></div></div>');
            ...
            for (var i = 0; i < $(SECTION_SEL).length; i++) {
                ...
                var pagItem = '<div class="pagItem"><a href="#' + link + '"></a>';

                // Only add tooltip if needed (defined by user)
                var tooltip = options.navigationTooltips[i];

                if (typeof tooltip !== 'undefined' && tooltip !== '') {
                    pagItem += '<div class="' + SECTION_NAV_TOOLTIP + ' ' + options.navigationPosition + '">' + tooltip + '</div>';
                }

                pagItem += '</div>';

                nav.find('.pagInner').append(pagItem);
            }
            ...
            $(SECTION_NAV_SEL).find('.pagItem').eq($(SECTION_ACTIVE_SEL).index(SECTION_SEL)).find('a').addClass(ACTIVE);
        }
        ...
        */
        function landscapeScroll(slides, destiny){
            ...
            slidesNav.find('.pagItem').eq(slideIndex).find('a').addClass(ACTIVE);
        }
        ...
        function activateNavDots(name, sectionIndex){
            if(options.navigation){
                ...
                if(name){
                    ...
                    $(SECTION_NAV_SEL).find('.pagItem').eq(sectionIndex).find('a').addClass(ACTIVE);
                }
            }
        }
        ...
        */
        function addSlidesNavigation(section, numSlides){
            ...
            nav.find('.pagItem').first().find('a').addClass(ACTIVE);
        }
