...
(function(a, b) {
    ...
    f.extend({
        Deferred: function(a) {
            var b = f.Callbacks("once memory"), c = f.Callbacks("once memory"), d = f.Callbacks("memory"), e = "pending", g = { resolve: b, reject: c, notify: d },
                h = {
    ...
    f.event = {
        ...
        toggle: function(a) {
            var b = arguments, c = a.guid || f.guid++, d = 0,
                e = function(c) {
    ...
    bV = bQ.exec(bU.toLowerCase()) || [], f.fn.extend({
        ...
        ajax: function(a, c) {
            ...
            var d = f.ajaxSetup({}, c), e = d.context || d, g = e !== d && (e.nodeType || e instanceof f) ? f(e) : f.event, h = f.Deferred(), i = f.Callbacks("once memory"), j = d.statusCode || {}, k, l = {}, m = {}, n, o, p, q, r, s = 0, t, u,
                v = {
                    readyState: 0,
