    ...
    $.fn.fcbkcomplete = function(opt) {
        return this.queue(function() {
            ...
            function elPrepare() {
                ...
                element.remove();
                element = temp_elem;
                $(element).bind("addItem", function(event, data) { addItem(data.title, data.value, 0, 0, 0) });
            ...
            function addMembers(etext, data) {
                ...
                if (data != null && data.length) {
                    $.each(data, function(i, val) { cache.set(xssPrevent(val.key), xssPrevent(val.value)) })
                }
            ...
            function maxItems() { return options.maxitems != 0 && (holder.children("li.bit-box").length < options.maxitems) }
            ...
            var json_cache_object = {
                ...
                'get': function(id) { return element.data("jsoncache")[id] != "undefined" ? element.data("jsoncache")[id] : null },
                'init': function() { element.data("jsoncache", {}) }
            };
            ...
            var cache = {
                ...
                'get': function(id) { return element.data("cache")[id] != "undefined" ? element.data("cache")[id] : null },
                'clear': function() { element.data("cache", {}) },
                'length': function() {
