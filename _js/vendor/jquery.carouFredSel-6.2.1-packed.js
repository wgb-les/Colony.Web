            ...
            FN._unbind_events(), $cfs.bind(cf_e("stop", conf), function(a, b) {
                ...
                case "fade":
                    scrl.anims.push([
                        ...
                        function() {
                            E(), G(), I(), K(), O(), N(), scrl = sc_setScroll(D, b.easing, conf), scrl.anims.push([
                                $cfs, {
                                    opacity: 1
                                },
                                M
                ...
                case "fade":
                    scrl.anims.push([
                        ...
                        function() {
                            C(), E(), G(), K(), J(), scrl = sc_setScroll(B, b.easing, conf), scrl.anims.push([
                                $cfs, {
                                    opacity: 1
                                },
                                I
                ...
                case "cover":
                    ...
                    break;
                case "cover-fade":
                    $cfs.css(opts.d.left, $wrp[opts.d.width]()), scrl.anims.push([
                        s, {
                            opacity: 0
                        }
        ...
        if (opts.cookie && start_arr.unshift(parseInt(cf_getCookie(opts.cookie), 10)), start_arr.length > 0)
            for (var a = 0, l = start_arr.length; l > a; a++) {
                ...
                if (0 != s) {
                    ...
                    if ($cfs.triggerHandler(cf_e("slideTo", conf), [
                        s, 0, !0, {
                            fx: "none"
                        }
                    ])) break;
