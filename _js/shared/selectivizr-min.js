...
(function(j) {
    ...
    function I(a) {
        ...
        if (a.charAt(0) == ":")
            ...
            case "target":
                if (m == 8) {
                    c = function(a) {
                        ...
                        k(j, "hashchange", function() { g(a, d, c()) });
                        return c()
                    };
                    break
                }
            ...
            case "checked":
                c = function(a) {
                    J.test(a.type) && k(a, "propertychange", function() { event.propertyName == "checked" && g(a, d, a.checked !== b) });
                    return a.checked !== b
                };
                break;
            case "disabled":
            ...
            case "enabled":
                c = function(c) {
                    if (K.test(c.tagName))return k(c, "propertychange", function() { event.propertyName == "$disabled" && g(c, d, c.a === b) }), q.push(c), c.a = c.disabled, c.disabled === b;
            ...
            case "hover":
                ...
                c = function(a) {
                    k(a, b ? f : e, function() { g(a, d, !0) });
                    k(a, b ? e : f, function() { g(a, d, !1) });
                    return b
                };
                break;
            default:
    ...
    function w(a) { return M + "-" + (m == 6 && N ? O++ : a.replace(P, function(a) { return a.charCodeAt(0) })) }

    function D(a) { return a.replace(x, h).replace(Q, o) }
    ...
    function k(a, c, d) { a.attachEvent("on" + c, d) }
    ...
    function y(a) {
        if (a)
            return n.open("GET", a, !1), n.send(), (n.status == 200 ? n.responseText : i).replace(R, i).replace(S, function(c, d, b, e, f) { return y(r(b || f, a)) }).replace(T, function(c, d, b) {
                d = d || i;
    ...
    if (! /*@cc_on!@*/true) {
        var f = document, p = f.documentElement,
            n = function() {
        ...
        if (!(f.compatMode != "CSS1Compat" || m < 6 || m > 8 || !n)) {
            ...
            (function(a, c) {
                ...
                function b(d) { if (!(d.type == "readystatechange" && f.readyState != "complete") && ((d.type == "load" ? a : f).detachEvent("on" + d.type, b, !1), !e && (e = !0)))c.call(a, d.type || d) }
