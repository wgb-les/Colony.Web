{
	"behaviourId": "CmsAddJob",
	"page": {
		"label": "Add Job",
		"back": "#/jobs/index/?siteId=<%=App.Colony.currentSiteId%>&jobCategoryId=<%=App.QueryString['jobCategoryId'] || 0%>",
		"backdescription": "jobs",
		"messages": [{
			"message": "AddJob",
			"behaviourId": "CmsListJob",
			"trigger": "submit",
			"success": "redirect:/jobs/index/?siteId=<%=App.Colony.currentSiteId%>&jobCategoryId=<%=App.QueryString['jobCategoryId'] || 0%>"
		}]
	},
	"componentContainer": [
		{
