...
CKEDITOR.plugins.add( 'ColonyLink', {
	...
	init: function( editor ) {
		...
		editor.addCommand( 'ColonyLink', new CKEDITOR.dialogCommand( 'ColonyLink', {
		...
		editor.setKeystroke( CKEDITOR.CTRL + 76 /*L*/, 'ColonyLink' );

		if ( editor.ui.addButton ) {
			editor.ui.addButton( 'ColonyLink', {
